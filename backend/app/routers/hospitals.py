...
def get_surge_predictions(ward_id: int | None = None, db: Session = Depends(get_db)):
    ...
    for hospital in hospitals:
        ...
        prediction = HospitalPrediction(
            ...
            expected_opd_demand=surge["expected_opd_demand"],
            projected_bed_occupancy_pct=surge["projected_bed_occupancy_pct"],
            emergency_resource_score=surge["emergency_resource_score"],
